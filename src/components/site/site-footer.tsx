    ...
    <>
      ...
      <div className="w-full py-6">
        <div className="flex w-full items-start">
          {/* Social icons + CMS content — flush left */}
          <div className="flex shrink-0 flex-col gap-4 pl-6 pt-1 text-white lg:pl-10">
            ...
            {(content.eyebrow || content.title || content.body) ? (
              <div className="max-w-[260px] space-y-1">
                ...
                {content.body ? (
                  <p className="text-xs leading-6 text-white/80">{content.body}</p>
                ) : null}
              </div>
            ) : null}
          </div>
